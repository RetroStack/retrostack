...
export function DimensionPresetSelector({
  ...
  const isCurrentDimension = (width: number, height: number) =>
    currentWidth === width && currentHeight === height;

  const handleSelect = (preset: DimensionPresetWithExamples) => {
  ...
  const visiblePresets: DimensionPresetWithExamples[] = [];
  const overflowPresets: DimensionPresetWithExamples[] = [];
